...
public class TestData {
	...
	public static String TASK_JSON  = "{\"identifier\":\"tsk11231jh22\",\"planIdentifier\":\"IRS_2018_S1\",\"groupIdentifier\":\"2018_IRS-3734{\",\"status\":\"Ready\",\"businessStatus\":\"Not Visited\",\"priority\":\"routine\",\"code\":\"IRS\",\"description\":\"Spray House\",\"focus\":\"IRS Visit\",\"for\":\"location.properties.uid:41587456-b7c8-4c4e-b433-23a786f742fc\",\"executionPeriod\":{\"start\":\"2018-11-10T2200\"},\"authoredOn\":\"2018-10-31T0700\",\"lastModified\":\"2018-10-31T0700\",\"owner\":\"demouser\",\"note\":[{\"authorString\":\"demouser\",\"time\":\"2018-01-01T0800\",\"text\":\"This should be assigned to patrick.\"}],\"serverVersion\":0,\"reasonReference\":\"reasonrefuuid\",\"location\":\"catchment1\",\"requester\":\"chw1\",\"syncStatus\":null,\"structureId\":null,\"rowid\":null}";
	...
	public static String EUSM_PLAN = "{\t\"identifier\": \"335ef7a3-7f35-58aa-8263-4419464946d8\",\t\"version\": \"1\",\t\"name\": \"EUSM Mission 2020-11-17\",\t\"title\": \"EUSM Mission 2020-11-17\",\t\"description\": \"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse egestas lorem non nunc tincidunt fermentum. Praesent vitae commodo est. Phasellus.\",\t\"status\": \"active\",\t\"date\": \"2020-11-17\",\t\"effectivePeriod\": {\t\t\"start\": \"2020-11-17\",\t\t\"end\": \"2021-12-24\"\t},\t\"useContext\": [{\t\t\"code\": \"taskGenerationStatus\",\t\t\"valueCodableConcept\": \"internal\"\t}],\t\"jurisdiction\": [{\t\t\"code\": \"3724\"\t}],\t\"serverVersion\": 1599112764477,\t\"goal\": [{\t\t\t\"id\": \"Product_Check\",\t\t\t\"description\": \"Check for all products (100%) within the jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of products checked\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t},\t\t{\t\t\t\"id\": \"Fix_Product_Problem\",\t\t\t\"description\": \"Fix problems for all products (100%) within the jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of products problems fixed\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t},\t\t{\t\t\t\"id\": \"Record_GPS\",\t\t\t\"description\": \"Record GPS for all service points without GPS within the jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of GPS recorded\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t},\t\t{\t\t\t\"id\": \"Service_Point_Check\",\t\t\t\"description\": \"Conduct checks for all service point (100%) within the Jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of service points checked\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t}\t],\t\"action\": [{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 1,\t\t\t\"title\": \"Product Check\",\t\t\t\"description\": \"Check for all products (100%) within the jurisdiction\",\t\t\t\"code\": \"Product Check\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Product_Check\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Device\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"plan-activation\"\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Product exists\",\t\t\t\t\t\"expression\": \"$this.is(FHIR.Bundle)\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"product_check.json\",\t\t\t\"type\": \"create\"\t\t},\t\t{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 2,\t\t\t\"title\": \"Fix Product Problem\",\t\t\t\"description\": \"Fix problems for all products (100%) within the jurisdiction\",\t\t\t\"code\": \"Fix Product Problems\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Fix_Product_Problem\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Device\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"event-submission\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Trigger when a Fix Product event is submitted\",\t\t\t\t\t\"expression\": \"questionnaire = 'flag_problem'\"\t\t\t\t}\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Product exists\",\t\t\t\t\t\"expression\": \"$this.is(FHIR.QuestionnaireResponse)\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"product_check.json\",\t\t\t\"type\": \"create\"\t\t},\t\t{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 3,\t\t\t\"title\": \"Record GPS\",\t\t\t\"description\": \"Record GPS for all service points (100%) without GPS within the jurisdiction\",\t\t\t\"code\": \"Record GPS\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Record_GPS\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Location\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"plan-activation\"\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Service point does not have geometry\",\t\t\t\t\t\"expression\": \"$this.identifier.where(system='hasGeometry').value='false'\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"record_gps.json\",\t\t\t\"type\": \"create\"\t\t},\t\t{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 3,\t\t\t\"title\": \"Service Point Check\",\t\t\t\"description\": \"Conduct checkfor all service points (100%) within the jurisdiction\",\t\t\t\"code\": \"Service Point Check\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Service_Point_Check\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Location\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"plan-activation\"\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"All service points\",\t\t\t\t\t\"expression\": \"$this.is(FHIR.Location)\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"service_point_check.json\",\t\t\t\"type\": \"create\"\t\t}\t],\t\"experimental\": false}";
	public static String FLAG_PROBLEM_EVENT = "{    \"baseEntityId\": \"ddcaf383-882e-448b-b701-8b72cb0d4e7a\",    \"duration\": 0,    \"entityType\": \"product\",    \"eventDate\": \"2020-12-02T00:00:00.000+0300\",    \"eventType\": \"flag_problem\",    \"formSubmissionId\": \"758e86e4-87c7-4b63-897f-b656e175968e\",    \"locationId\": \"f3199af5-2eaf-46df-87c9-40d59606a2fb\",    \"obs\": [        {            \"fieldCode\": \"flag_problem\",            \"fieldDataType\": \"text\",            \"fieldType\": \"formsubmissionField\",            \"formSubmissionField\": \"flag_problem\",            \"humanReadableValues\": [],            \"keyValPairs\": {                \"not_there\": \"Product is not there\"            },            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"Product is not there\"            ]        },        {            \"fieldCode\": \"not_there\",            \"fieldDataType\": \"text\",            \"fieldType\": \"formsubmissionField\",            \"formSubmissionField\": \"not_there\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"never_received\"            ]        },        {            \"fieldCode\": \"issue_details\",            \"fieldDataType\": \"text\",            \"fieldType\": \"formsubmissionField\",            \"formSubmissionField\": \"issue_details\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"some details\"            ]        },        {            \"fieldCode\": \"163137AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",            \"fieldDataType\": \"start\",            \"fieldType\": \"concept\",            \"formSubmissionField\": \"start\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"2020-12-02 18:13:20\"            ]        },        {            \"fieldCode\": \"163138AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",            \"fieldDataType\": \"end\",            \"fieldType\": \"concept\",            \"formSubmissionField\": \"end\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"2020-12-02 18:13:31\"            ]        },        {            \"fieldCode\": \"163149AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",            \"fieldDataType\": \"deviceid\",            \"fieldType\": \"concept\",            \"formSubmissionField\": \"deviceid\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"358240051111110\"            ]        },        {            \"fieldCode\": \"163150AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",            \"fieldDataType\": \"subscriberid\",            \"fieldType\": \"concept\",            \"formSubmissionField\": \"subscriberid\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"310260000000000\"            ]        },        {            \"fieldCode\": \"163151AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",            \"fieldDataType\": \"simserial\",            \"fieldType\": \"concept\",            \"formSubmissionField\": \"simserial\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"89014103211118510720\"            ]        },        {            \"fieldCode\": \"163152AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",            \"fieldDataType\": \"phonenumber\",            \"fieldType\": \"concept\",            \"formSubmissionField\": \"phonenumber\",            \"humanReadableValues\": [],            \"parentCode\": \"\",            \"saveObsAsArray\": false,            \"values\": [                \"+15555215554\"            ]        }    ],    \"providerId\": \"demo\",    \"team\": \"Commune A Team\",    \"teamId\": \"abf1be43-32da-4848-9b50-630fb89ec0ef\",    \"version\": 1606922011085,    \"clientApplicationVersion\": 1,    \"clientApplicationVersionName\": \"0.0.3-v4-SNAPSHOT\",    \"dateCreated\": \"2020-12-02T18:13:31.085+0300\",    \"type\": \"Event\",    \"details\": {        \"mission\": \"SS\",        \"locationName\": \"EPP Ambodisatrana 2\",        \"productId\": \"1\",        \"locationId\": \"3734\",        \"taskId\": \"c6dd4abc-fb3e-4f72-afb8-923fc43f44d7\",        \"productName\": \"Midwifery Kit\",        \"planIdentifier\": \"335ef7a3-7f35-58aa-8263-4419464946d8\",        \"appVersionName\": \"2.0.1-v004-SNAPSHOT\",        \"formVersion\": \"0.0.1\"    }}";
