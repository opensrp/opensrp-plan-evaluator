...
public class TestData {
	...
	public static String EUSM_PLAN = "{\t\"identifier\": \"335ef7a3-7f35-58aa-8263-4419464946d8\",\t\"version\": \"1\",\t\"name\": \"EUSM Mission 2020-11-17\",\t\"title\": \"EUSM Mission 2020-11-17\",\t\"description\": \"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse egestas lorem non nunc tincidunt fermentum. Praesent vitae commodo est. Phasellus.\",\t\"status\": \"active\",\t\"date\": \"2020-11-17\",\t\"effectivePeriod\": {\t\t\"start\": \"2020-11-17\",\t\t\"end\": \"2021-12-24\"\t},\t\"useContext\": [{\t\t\"code\": \"taskGenerationStatus\",\t\t\"valueCodableConcept\": \"internal\"\t}],\t\"jurisdiction\": [{\t\t\"code\": \"3724\"\t}],\t\"serverVersion\": 1599112764477,\t\"goal\": [{\t\t\t\"id\": \"Product_Check\",\t\t\t\"description\": \"Check for all products (100%) within the jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of products checked\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t},\t\t{\t\t\t\"id\": \"Fix_Product_Problem\",\t\t\t\"description\": \"Fix problems for all products (100%) within the jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of products problems fixed\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t},\t\t{\t\t\t\"id\": \"Record_GPS\",\t\t\t\"description\": \"Record GPS for all service points without GPS within the jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of GPS recorded\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t},\t\t{\t\t\t\"id\": \"Service_Point_Check\",\t\t\t\"description\": \"Conduct checks for all service point (100%) within the Jurisdiction\",\t\t\t\"priority\": \"medium-priority\",\t\t\t\"target\": [{\t\t\t\t\"measure\": \"Percent of service points checked\",\t\t\t\t\"detail\": {\t\t\t\t\t\"detailQuantity\": {\t\t\t\t\t\t\"value\": 100,\t\t\t\t\t\t\"comparator\": \">\",\t\t\t\t\t\t\"unit\": \"Percent\"\t\t\t\t\t}\t\t\t\t},\t\t\t\t\"due\": \"2020-12-24\"\t\t\t}]\t\t}\t],\t\"action\": [{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 1,\t\t\t\"title\": \"Product Check\",\t\t\t\"description\": \"Check for all products (100%) within the jurisdiction\",\t\t\t\"code\": \"Product Check\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Product_Check\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Bundle\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"plan-activation\"\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Product exists\",\t\t\t\t\t\"expression\": \"$this.is(FHIR.Bundle)\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"product_check.json\",\t\t\t\"type\": \"create\"\t\t},\t\t{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 2,\t\t\t\"title\": \"Fix Product Problem\",\t\t\t\"description\": \"Fix problems for all products (100%) within the jurisdiction\",\t\t\t\"code\": \"Fix Product Problems\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Fix_Product_Problem\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Bundle\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"event-submission\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Trigger when a Fix Product event is submitted\",\t\t\t\t\t\"expression\": \"questionnaire = 'flag_problem'\"\t\t\t\t}\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Product exists\",\t\t\t\t\t\"expression\": \"$this.is(FHIR.QuestionnaireResponse)\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"product_check.json\",\t\t\t\"type\": \"create\"\t\t},\t\t{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 3,\t\t\t\"title\": \"Record GPS\",\t\t\t\"description\": \"Record GPS for all service points (100%) without GPS within the jurisdiction\",\t\t\t\"code\": \"Record GPS\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Record_GPS\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Location\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"plan-activation\"\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"Service point does not have geometry\",\t\t\t\t\t\"expression\": \"$this.identifier.where(system='hasGeometry').value='false'\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"record_gps.json\",\t\t\t\"type\": \"create\"\t\t},\t\t{\t\t\t\"identifier\": \"bd90510c-e769-5176-ad18-5a256822822a\",\t\t\t\"prefix\": 3,\t\t\t\"title\": \"Service Point Check\",\t\t\t\"description\": \"Conduct checkfor all service points (100%) within the jurisdiction\",\t\t\t\"code\": \"Service Point Check\",\t\t\t\"timingPeriod\": {\t\t\t\t\"start\": \"2020-11-17\",\t\t\t\t\"end\": \"2020-12-24\"\t\t\t},\t\t\t\"reason\": \"Routine\",\t\t\t\"goalId\": \"Service_Point_Check\",\t\t\t\"subjectCodableConcept\": {\t\t\t\t\"text\": \"Location\"\t\t\t},\t\t\t\"trigger\": [{\t\t\t\t\"type\": \"named-event\",\t\t\t\t\"name\": \"plan-activation\"\t\t\t}],\t\t\t\"condition\": [{\t\t\t\t\"kind\": \"applicability\",\t\t\t\t\"expression\": {\t\t\t\t\t\"description\": \"All service points\",\t\t\t\t\t\"expression\": \"$this.is(FHIR.Location)\"\t\t\t\t}\t\t\t}],\t\t\t\"definitionUri\": \"service_point_check.json\",\t\t\t\"type\": \"create\"\t\t}\t],\t\"experimental\": false}";
